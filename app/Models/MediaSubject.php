...
class MediaSubject extends Model
{
    ...
    {
        return $this->belongsTo(Picture::class, 'id', 'post_id')->where('post_type', 'media_subject')->where('image_type', 'picture_main');
    }

    public function childImages()
    {
        return $this->hasMany(Picture::class, 'post_id')->where('post_type', 'media_subject')->where('image_type', 'picture_child');
    }
    ...
    {
        return $this->belongsTo(Picture::class, 'id', 'post_id')->where('post_type', 'mediasubject')->where('image_type', 'slider');
    }
}
