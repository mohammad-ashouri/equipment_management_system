...
class SocialMedia extends Model
{
    ...
    {
        return $this->belongsTo(Picture::class, 'id', 'post_id')->where('post_type', 'social_media')->where('image_type', 'picture_main');
    }

    public function childImages()
    {
        return $this->hasMany(Picture::class, 'post_id')->where('post_type', 'social_media')->where('image_type', 'picture_child');
    }
    ...
    {
        return $this->belongsTo(Picture::class, 'id', 'post_id')->where('post_type', 'socialmedia')->where('image_type', 'slider');
    }
}
