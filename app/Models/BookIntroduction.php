...
class BookIntroduction extends Model
{
    ...
    public $table = 'book_introductions';
    protected $fillable = [
        'slug',
        'title',
        'body',
    ...
    {
        return $this->belongsTo(Picture::class, 'id', 'post_id')->where('post_type', 'book_introductions')->where('image_type', 'picture_main');
    }

    public function childImages()
    {
        return $this->hasMany(Picture::class, 'post_id')->where('post_type', 'book_introductions')->where('image_type', 'picture_child');
    }
    ...
    {
        return $this->belongsTo(Picture::class, 'id', 'post_id')->where('post_type', 'bookintroduction')->where('image_type', 'slider');
    }
