...
class InternationalDocument extends Model
{
    ...
    public $table = 'international_documents';
    protected $fillable = [
        'slug',
        'title',
        'body',
    ...
    {
        return $this->belongsTo(Picture::class, 'id', 'post_id')->where('post_type', 'international_document')->where('image_type', 'picture_main');
    }

    public function childImages()
    {
        return $this->hasMany(Picture::class, 'post_id')->where('post_type', 'international_document')->where('image_type', 'picture_child');
    }
    ...
    {
        return $this->belongsTo(Picture::class, 'id', 'post_id')->where('post_type', 'internationaldocument')->where('image_type', 'slider');
    }
}
