...
class Note extends Model
{
    ...
    {
        return $this->belongsTo(Picture::class, 'id', 'post_id')->where('post_type', 'note')->where('image_type', 'picture_main');
    }
    ...
    {
        return $this->belongsTo(Picture::class, 'id', 'post_id')->where('post_type', 'note')->where('image_type', 'slider');
    }
}
