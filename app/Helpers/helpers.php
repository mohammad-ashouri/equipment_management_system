...
if (!defined('TRANSLATIONS')) {
    define('TRANSLATIONS', [
        ...
        'server' => 'سرور',
        'paper_cutter' => 'برش دهنده کاغذ',
        'laminating_machine' => 'دستگاه سلفون کش و لمینیت',
        'hot_glue_binding' => 'دستگاه صحافی چسب گرم',
        'spring_binding' => 'دستگاه صحافی چسب گرم',
        'shredder' => 'کاغذ خردکن',
        'doors_number' => 'تعداد در',
        'closets_number' => 'تعداد کمد',
        'front_furniture_table' => 'جلومبلی/میز عسلی',
        'heater' => 'بخاری',
        'whiteboard' => 'تخته وایت بورد',
        'whiteboard_holder' => 'پایه تخته وایت بورد',
        'keyboard' => 'صفحه کلید',
        'microwave' => 'مایکروفر',
        'air_conditioner' => 'کولر گازی',
        'oven' => 'اجاق',
        'fire_extinguisher' => 'کپسول آتش نشانی',
        'noticeboard' => 'تخته اعلانات',
        'mouse' => 'موس',
        'water_dispenser' => 'آبسردکن',
        'suggestion_box' => 'صندوق پیشنهادات',
        'ladder' => 'نردبان',
        'bed' => 'تخت خواب',
        'water_purifier' => 'تصفیه کننده آب',
        'television' => 'تلوزیون',
        'coat_hanger' => 'جالباسی',
        'ping_pong_table' => 'میز پینگ پنگ',
