...
class PermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['name' => 'لیست سه پایه دوربین', 'guard_name' => 'web'],
            ['name' => 'ایجاد سه پایه دوربین', 'guard_name' => 'web'],
            ['name' => 'ویرایش سه پایه دوربین', 'guard_name' => 'web'],
            ['name' => 'نمایش جزئیات سه پایه دوربین', 'guard_name' => 'web'],
            ['name' => 'حذف سه پایه دوربین', 'guard_name' => 'web'],
