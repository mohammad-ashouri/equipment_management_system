...
class PermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $role = Role::create(['name' => 'ادمین کل']);
        ...
        $role = Role::create(['name' => 'کارشناس فنی']);
        $role->givePermissionTo([
            'لیست مقادیر اولیه',
            'لیست تجهیزات سخت افزاری',
            'لیست تجهیزات دیجیتال',
        ...
        $role = Role::create(['name' => 'کارشناس اداری']);
        $role->givePermissionTo([
            'لیست تجهیزات پشتیبانی',
        ...
        $role = Role::where('name', 'کارشناس فنی')->first();
        ...
        $role = Role::where('name', 'کارشناس اداری')->first();
