    ...
    <main class="flex-1 bg-gray-100 py-6 px-8">
        <div class="mx-auto lg:mr-72">
            ...
            <div class="bg-white rounded shadow flex flex-col ">
                {{ html()->form('POST')->route('NetworkCards.store')->acceptsFiles()->id('create-catalog')->open() }}
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select name="connectivity_type"
                                    ...
                                    required>
                                <option value="" disabled selected>انتخاب کنید</option>
                                <option value="PCI/PCIe" @if(old('connectivity_type')=='PCI/PCIe') selected @endif>
                                    PCI/PCIe
                                </option>
                        ...
                        <div>
                            ...
                            <select name="function_type"
                                    ...
                                    required>
                                <option value="" disabled selected>انتخاب کنید</option>
                                <option value="LAN" @if(old('function_type')=='LAN') selected @endif>
                                    LAN
                                </option>
                                <option value="WLAN" @if(old('function_type')=='WLAN') selected @endif>WLAN</option>
                            </select>
                        </div>
                    </div>
                </div>
