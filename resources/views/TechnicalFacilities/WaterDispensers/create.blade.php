                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select name="refrigerator"
                                    ...
                                    required>
                                <option value="" disabled selected>انتخاب کنید</option>
                                <option value="1" @if(old('refrigerator'==1)) selected @endif>
                                    دارد
                                </option>
                                <option value="0" @if(old('refrigerator'==0)) selected @endif>
                                    ندارد
                                </option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="tank"
                                    ...
                                    required>
                                <option value="" disabled selected>انتخاب کنید</option>
                                <option value="1" @if(old('tank'==1)) selected @endif>
                                    دارد
                                </option>
                                <option value="0" @if(old('tank'==0)) selected @endif>
                                    ندارد
                                </option>
                            </select>
                        </div>
