...
@section('content')
    <main class="flex-1 bg-gray-100 py-6 px-8">
        <div class="mx-auto lg:mr-72">
            <h1 class="text-2xl font-bold mb-4">ایجاد استند گلدان</h1>
            @include('layouts.components.errors')
            <div class="bg-white rounded shadow flex flex-col ">
                {{ html()->form('POST')->route('FlowerPots.store')->acceptsFiles()->id('create-catalog')->open() }}
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select name="material"
                                ...
                                <option value="چینی" @if(old('material')=='چینی') selected @endif>
                                    چینی
                                </option>
                                <option value="سرامیک" @if(old('material')=='سرامیک') selected @endif>
                                    سرامیک
                                </option>
                                <option value="شیشه" @if(old('material')=='شیشه') selected @endif>
                                    شیشه
                                </option>
                            </select>
                        </div>
