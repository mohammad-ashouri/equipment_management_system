...
@section('content')
    <main class="flex-1 bg-gray-100 py-6 px-8">
        <div class="mx-auto lg:mr-72">
            <h1 class="text-2xl font-bold mb-4">ایجاد برش دهنده کاغذ</h1>
            @include('layouts.components.errors')
            <div class="bg-white rounded shadow flex flex-col ">
                {{ html()->form('POST')->route('PaperCutters.store')->acceptsFiles()->id('create-catalog')->open() }}
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select name="type"
                                    ...
                                    required>
                                <option value="" disabled selected>انتخاب کنید</option>
                                <option value="دستی" @if(old('type')=='دستی') selected @endif>
                                    دستی
                                </option>
                                <option value="الکتریکی" @if(old('type')=='الکتریکی') selected @endif>
                                    الکتریکی
                                </option>
                            </select>
                        </div>
