...
@section('content')
    <main class="flex-1 bg-gray-100 py-6 px-8">
        <div class="mx-auto lg:mr-72">
            <h1 class="text-2xl font-bold mb-4">ایجاد تب سنج</h1>
            @include('layouts.components.errors')
            <div class="bg-white rounded shadow flex flex-col ">
                {{ html()->form('POST')->route('Thermometers.store')->acceptsFiles()->id('create-catalog')->open() }}
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select name="type"
                                    ...
                                    required>
                                <option value="" disabled selected>انتخاب کنید</option>
                                <option value="جیوه‌ای" @if(old('type')=='جیوه‌ای') selected @endif>
                                    جیوه‌ای
                                </option>
                                <option value="دیجیتال" @if(old('type')=='دیجیتال') selected @endif>
                                    دیجیتال
                                </option>
                                <option value="لیزری" @if(old('type')=='لیزری') selected @endif>
                                    لیزری
                                </option>
                            </select>
                        </div>
