...
@section('content')
    @switch($equipment->equipmentType->name)
        ...
        @case('external_hard_disk')
            @php
                $external_hard_disk=ExternalHardDisk::whereStatus(1)->get();
            @endphp
            @break
    @endswitch
