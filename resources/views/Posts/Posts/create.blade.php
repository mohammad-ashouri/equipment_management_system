...
@section('content')
    <main class="flex-1 bg-gray-100 py-6 px-8">
        <div class="mx-auto lg:mr-72">
            <div class="flex mb-4">
                <h1 class="text-2xl font-bold mb-4">ایجاد سند</h1>
                @if (isset($id) and $model->status==2)
                    <x-show-draft-button route="documents" token="{{ $model->draft_token }}"></x-show-draft-button>
                @endif
            </div>
            @include('layouts.components.errors')
            @include('layouts.components.success')
            <div class="bg-gray-300 rounded shadow flex flex-col ">
                {{ html()->form('POST')->route('Posts.store')->acceptsFiles()->id('create-post')->open() }}
                ...
                <div class="bg-white mt-10 rounded shadow flex flex-col p-4">
                    ...
                    <p class="text-blue-600 text-sm mt-2 mr-4">کلمه کلیدی را وارد کنید و enter را فشار دهید</p>
                </div>
                <div class="bg-white mt-10 rounded shadow flex flex-col p-4">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" id="document_internal_number" name="document_internal_number"
                                   value="{{old('document_internal_number') }}"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div>
                            ...
                            >
                                @foreach($documentTypes as $documentType)
                                    <option {{ old('document_type') ? 'selected' : '' }} value="{{$documentType->id}}">
                                        {{$documentType->name}}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" id="recipient_of_document" name="recipient_of_document"
                                   value="{{old('recipient_of_document') }}"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
