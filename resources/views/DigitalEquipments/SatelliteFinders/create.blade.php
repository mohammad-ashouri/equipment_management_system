...
@section('content')
    <main class="flex-1 bg-gray-100 py-6 px-8">
        <div class="mx-auto lg:mr-72">
            <h1 class="text-2xl font-bold mb-4">ایجاد فایندر ماهواره</h1>
            @include('layouts.components.errors')
            <div class="bg-white rounded shadow flex flex-col ">
                {{ html()->form('POST')->route('SatelliteFinders.store')->acceptsFiles()->id('create-catalog')->open() }}
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select name="type"
                                ...
                                <option value="" disabled selected>انتخاب کنید</option>
                                <option value="تصویری"
                                        @if(old('type')=='تصویری') selected @endif>تصویری
                                </option>
                                <option value="آنالوگ"
                                        @if(old('type')=='آنالوگ') selected @endif>آنالوگ
                                </option>
                                <option value="تصویری/سیگنالی"
                                        @if(old('type')=='تصویری/سیگنالی') selected @endif>تصویری/سیگنالی
                                </option>
                            </select>
                        </div>
                    </div>
