...
@section('content')
    <main class="flex-1 bg-gray-100 py-6 px-8">
        <div class="mx-auto lg:mr-72">
            <h1 class="text-2xl font-bold mb-4">ایجاد دوربین</h1>
            @include('layouts.components.errors')
            <div class="bg-white rounded shadow flex flex-col ">
                {{ html()->form('POST')->route('Cameras.store')->acceptsFiles()->id('create-catalog')->open() }}
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select name="type"
                                    ...
                                    required>
                                <option value="" disabled selected>انتخاب کنید</option>
                                <option value="عکسبرداری" @if(old('type')=='عکسبرداری') selected @endif>
                                    عکسبرداری
                                </option>
                                <option value="فیلمبرداری" @if(old('type')=='فیلمبرداری') selected @endif>
                                    فیلمبرداری
                                </option>
                            </select>
                        </div>
