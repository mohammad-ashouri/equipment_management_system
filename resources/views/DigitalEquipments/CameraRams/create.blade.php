...
@section('content')
    <main class="flex-1 bg-gray-100 py-6 px-8">
        <div class="mx-auto lg:mr-72">
            <h1 class="text-2xl font-bold mb-4">ایجاد رم دوربین</h1>
            @include('layouts.components.errors')
            <div class="bg-white rounded shadow flex flex-col ">
                {{ html()->form('POST')->route('CameraRams.store')->acceptsFiles()->id('create-catalog')->open() }}
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select name="type"
                                    ...
                                    required>
                                <option value="" disabled selected>انتخاب کنید</option>
                                <option value="SD" @if(old('type')=='SD') selected @endif>
                                    SD
                                </option>
                                <option value="microSD" @if(old('type')=='microSD') selected @endif>
                                    microSD
                                </option>
                            </select>
                        </div>
