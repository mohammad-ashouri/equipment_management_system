...
@section('content')
    <main class="flex-1 bg-gray-100 py-6 px-8">
        <div class="mx-auto lg:mr-72">
            <h1 class="text-2xl font-bold mb-4">سایر تجهیزات دیجیتال - مدیریت بر اطلاعات رم دوربین</h1>
            @include('layouts.components.errors')
            @include('layouts.components.success')
            <div class="bg-white rounded shadow p-6 flex flex-col ">
                @can('ایجاد رم دوربین')
                    <a type="button" href="{{route('CameraRams.create')}}"
                            ...
                            <tr class="bg-white">
                                ...
                                <td class="px-6 py-4">
                                    @can('ویرایش رم دوربین')
                                        <a href="{{ route('CameraRams.edit',$cameraRam->id) }}">
