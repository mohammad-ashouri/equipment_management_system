<div class="bg-white mt-10 rounded shadow flex flex-col p-4">
    <h3 class="font-bold mb-5">مستند مرتبط (پس از وارد نمودن کد مستند، کلید ctrl را فشار داده و منتظر پاسخ سرور
        باشید. در صورتی که مستند شما یافت شود، نام مستند در مقابل ورودی نمایش داده خواهد شد)</h3>
    <div class="grid gap-6 mb-6 md:grid-cols-1" id="documentariesContainer">
        <div>
            @if(old('documentaries'))
                @foreach(old('documentaries') as $index => $documentary)
                    <div class="flex">
                        <div class="">
