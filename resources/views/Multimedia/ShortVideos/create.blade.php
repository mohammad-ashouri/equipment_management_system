...
@section('content')
    <main class="flex-1 bg-gray-100 py-6 px-8">
        <div class="mx-auto lg:mr-72">
            <h1 class="text-2xl font-bold mb-4">ایجاد فیلم کوتاه</h1>
            @include('layouts.components.errors')
            <div class="bg-gray-300 rounded shadow flex flex-col ">
                {{ html()->form('POST')->route('ShortVideos.store')->acceptsFiles()->id('create-post')->open() }}
                        ...
                        <div>
                            ...
                            >
                                @foreach($multimediaSubjects as $multimediaSubject)
                                    <option @if(old('keywords')==$multimediaSubject->id) selected @endif value="{{$multimediaSubject->id}}">
                ...
                {{--                Similar multimedia create--}}
                <x-similar-short-videos-create :similarShortVideos="old('similar_short_videos', [])"/>
